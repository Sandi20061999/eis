                    ...
                    <ul class="clearfix">
                        <li class="icons dropdown">
                            ...
                            <div class="user-img c-pointer position-relative" data-toggle="dropdown">
                                ...
                                <img id="fotoProfil" src="<?= base_url() ?>/assets/img/profil/<?=$this->session->userdata('image') ?>" height="40" width="40" alt="">
                            </div>
                            <div class="drop-down dropdown-profile   dropdown-menu">
                                <div class="dropdown-content-body">
                                    <ul>
                                        ...
                                        <li>
                                            <a onclick="profil()"><i class="icon-user"></i> <span>Profile</span></a>
                                        </li>
                                        <hr class="my-2">
