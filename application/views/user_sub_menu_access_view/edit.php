    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">User Sub Menu Access View Edit</h3>
            </div>
			<?php echo form_open('user_sub_menu_access_view/edit/'.$user_sub_menu_access_view['id']); ?>
			<div class="box-body">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="sub_menu_id" class="form-control">
								...
								{
									$selected = ($user_sub_menu['id'] == $user_sub_menu_access_view['sub_menu_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="view_id" class="form-control">
								...
								{
									$selected = ($user_view['id'] == $user_sub_menu_access_view['view_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="is_active" class="form-control">
								...
								{
									$selected = ($value == $user_sub_menu_access_view['is_active']) ? ' selected="selected"' : "";
