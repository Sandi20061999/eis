							...
							foreach ($user_menus as $u) { ?>
								<tr>
									...
									<td>
										...
										<a href="<?= site_url('user_menu/index_sub/' . $u['id']); ?>" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="top" title="" data-original-title="Sub Menu"><i class="mdi mdi-home"></i></a>
									</td>
								</tr>
							<?php } ?>
						</tbody>
